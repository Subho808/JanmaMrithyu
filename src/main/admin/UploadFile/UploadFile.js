...
const UploadFiles = () => {
    ...
    const postQuery = async (e) => {
        ...
        return await axios.get(process.env.REACT_APP_API_URL_PREFIX+`/api/v1/getAllUpldCertificate`, {headers}).then((res) => {
    ...
    const download_file = async (file) => {
        ...
        await axios.get(process.env.REACT_APP_API_URL_PREFIX + `/api/v1/upldCrt/image/${file}`,  {
          headers: {
        ...
        () => [
            ...
            },
            {
                ...
                Cell: ({ renderedCellValue, row }) => (
                    ...
                    // </IconButton>
                    <IconButton  disabled={row.original.imageName==="default.png"} onClick={() => {download_file(row.original.imageName); console.log(row.original.imageName)}} style={{color:"#6259ca"}}><FileDownload/></IconButton>
        ...
        <form id="myForm" onSubmit={postQuery}>
                <div className="row mb-4 ms-4 mt-4">
                    ...
                    <div className="col-md-6">
                        <input className="form-control border border-primary" type="text" id="exampleFormControlSelect1" placeholder="Certificate No" />
                    </div>
...
export const CreateNewAccountModal = ({ open, columns, onClose, onSubmit, mode, rowId, setData, data, rowData, index}) => {
  ...
  <DialogContent>
    <UploadFilesForm mode={mode} setData={setData} data={data} rowData={rowData} index={index} />
  </DialogContent>
