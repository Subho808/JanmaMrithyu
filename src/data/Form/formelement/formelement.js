...
export function StatusSelect() {
  ...
  return (
    <MultiSelect
      className=" select2"
      displayValue="key"
      id="StatusSelectOption"
      
      onChange={handleOnchange}
      placeholder="--Select Status--"
      singleSelect="true"
      options={optionStatusselect}
    />
  );
}
//ViewSelect
...
export function PositionSelect() {
  ...
  return (
    <MultiSelect
      className=" select2"
      displayValue="key"
      id="ViewPositionOption"
      
      onChange={handleOnchange}
      placeholder="--Menu Type-"
      singleSelect="true"
      options={optionPositionselect}
    />
  );
}
//TypeSelect
