...
const UploadFiles = React.lazy(() =>
  import("./main/admin/UploadFile/UploadFile")
);
const GetAllUser = React.lazy(() =>
  import("./main/admin/GetAllUser/GetAllUser")
);
...
const DefaultCalendar = React.lazy(() =>
  import("./components/Components/DefaultCalendar/DefaultCalendar")
);
...
const FormElements = React.lazy(() =>
  import("./components/Form/FormElements/FormElements")
);
...
const Register = React.lazy(() => import("./main/common/register"));
        ...
        <React.Suspense fallback={Loaderimg()}>
          <Routes>
            ...
            <Route path="/janma-mrityutathya" element={<JanmaMrityutathyaPage />} />
              ...
              />
              <Route
                path={`${process.env.PUBLIC_URL}/dashboard0`}
                element={<Dashboard0 />}
              />
              <Route
